...
public class SortAdapter extends BaseAdapter<Integer> {

	public SortAdapter(Context context, List<Integer> data) {
		super(context, data);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageView ivImage;
		if (convertView == null) {
			convertView = getLayoutInflater().inflate(R.layout.sort_contents,
					null);
			ivImage = (ImageView) convertView
					.findViewById(R.id.iv_sort_contents);
